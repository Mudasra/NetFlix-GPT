...
const Header = () => {
  return (
    <div className="absolute flex w-full top-0 justify-between items-center z-10  px-32 py-4 bg-gradient-to-b from-black">
      <img
        className="w-44 "
        alt="logo"
      ...
      />
      <button className=" px-4 py-1 text-white font-semibold bg-red-600 hover:bg-red-700 rounded transition-colors duration-300 ease-in-out">
        Sign in
      </button>
    </div>
  );
